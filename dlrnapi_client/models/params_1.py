...
class Params1(object):
    ...
    """
    def __init__(self, max_age=None, reporting_job_id=None, success=None, job_id=None, sequential_mode=None, previous_job_id=None):
        """
    ...
    def reporting_job_id(self, reporting_job_id):
        ...
        if reporting_job_id is None:
            raise ValueError("Invalid value for `reporting_job_id`, must not be `None`")
