...
from dlrnapi_client import models
from dlrnapi_client.rest import ApiException
from dlrnapi_client.rest import RESTClientObject
...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'dlrnapi-client/1.0.0/python'
    ...
    def __call_api(self, resource_path, method,
        ...
        if path_params:
            ...
            for k, v in path_params:
                # no safe chars, encode everything
        ...
        if callback:
            if _return_http_data_only:
                ...
                callback((return_data, response_data.status,
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            # attributes `var_types`
            # and attributes which value is not None.
            # Convert attribute name to json key in
            # model definition for request.
            obj_dict = {attr: getattr(obj, attr)
                        for attr, _ in iteritems(obj.var_types)
            ...
            for k, v in iteritems(files):
                ...
                for n in file_names:
                    with open(n, 'rb') as f:
                        ...
                        params.append(tuple([k, tuple([filename,
                                                       filedata, mimetype])]))
    ...
    def __deserialize_file(self, response):
        ...
        Uses the filename from the `Content-Disposition` header if provided.
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not instance.var_types:
            return data

        for attr, attr_type in iteritems(instance.var_types):
            if data is not None \
               and attr in data \
